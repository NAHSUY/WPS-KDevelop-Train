...
{
	this->m_buttonPause = new ImageButton(":/Images/PUBLIC_PAUSE.png", this, QPoint(118, 514), 3);
	this->m_buttonStart = new ImageButton(":/Images/PUBLIC_START.png", this, QPoint(198, 526), 3);
	this->m_buttonEnd = new ImageButton(":/Images/PUBLIC_END.png", this, QPoint(163, 483), 3);
	this->m_buttonSetUp = new ImageButton(":/Images/PUBLIC_SETUP.png", this, QPoint(150, 552), 3);
	this->m_buttonExit = new ImageButton(":/Images/PUBLIC_EXIT.png", this, QPoint(20, 540), 3);
