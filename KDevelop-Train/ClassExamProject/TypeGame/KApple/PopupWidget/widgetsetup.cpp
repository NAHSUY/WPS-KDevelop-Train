...
{
	static const QPixmap pix(":/Images/APPLE_SETUP.png");
	return pix;
}
...
{
	this->m_buttonDEFAULT = new ImageButton(":/Images/DEFAULT.png", this, QPoint(360, 270), 3);
	this->m_buttonCANCEL = new ImageButton(":/Images/CANCEL.png", this, QPoint(270, 270), 3);
	this->m_buttonOK = new ImageButton(":/Images/OK.png", this, QPoint(180, 270), 3);
...
void sliderSetStyleSheet(QSlider*slider)
{
    ...
    QSlider::handle:horizontal {
        ...
        border-image: url(:/Images/SLIDER_SLIDER.png) 0 11 0 0 none none;
        border-width: 0;
    ...
    QSlider::handle:horizontal:pressed {
        border-image: url(:/Images/SLIDER_SLIDER.png) 0 0 0 11 none none;
        border-width: 0;
    }
)");
}
