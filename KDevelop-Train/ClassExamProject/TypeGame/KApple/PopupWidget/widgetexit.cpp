...
const QPixmap& WidgetExit::pixExit() {
	static const QPixmap pix(":/Images/MAIN_DLG_BG.png"); // 替换为你的图片路径
	return pix;
}
...
{
	this->m_buttonREPLAY = new ImageButton(":/Images/MAIN_DLG_REPLAY.png", this, QPoint(200, 130), 3);
	connect(this->m_buttonREPLAY, &ImageButton::clicked, this, &WidgetExit::m_buttonCancel_clicked);

	this->m_buttonExit = new ImageButton(":/Images/MAIN_DLG_EXIT.png", this, QPoint(30, 130), 3);
