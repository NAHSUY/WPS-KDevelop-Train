...
const QPixmap& WidgetWin::pixFail() {
	static const QPixmap pix(":/Images/APPLE_DLG_BG.png");
	return pix;
}
...
{
	this->m_buttonREPLAY = new ImageButton(":/Images/APPLE_DLG_REPLAY.png", this, QPoint(30, 130), 3);
	this->m_buttonEND = new ImageButton(":/Images/APPLE_DLG_END.s", this, QPoint(200, 130), 3);
	this->m_buttonNEXT = new ImageButton(":/Images/APPLE_DLG_NEXT.png", this, QPoint(115, 130), 3);
