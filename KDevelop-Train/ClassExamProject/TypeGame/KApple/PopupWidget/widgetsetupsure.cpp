...
const QPixmap& widgetSetUpSure::pixExit() {
	static const QPixmap pix(":/Images/MAIN_DLG_BG.png");
	return pix;
}
...
{
	this->m_buttonNO = new ImageButton(":/Images/NO.png", this, QPoint(30, 130), 3);
	this->m_buttonYES = new ImageButton(":/Images/YES.png", this, QPoint(200, 130), 3);
