...
{
	static const QPixmap pix(":/Images/APPLE_BAD.png");
	return pix;
}

const QPixmap& Apple::pixNormal()
{
	static const QPixmap pix(":/Images/APPLE_NORMAL.png");
	return pix;
}
...
void Apple::drawChar(QPainter* painter)
{
	...
	painter->drawText(this->pos() + QPoint(20, 40), QString(QChar(this->m_targetChar)));
}
void Apple::beHitten()
{
